...
const Day1 = {
  ...
  Day1EndofMorning: [
    ...
    'p Et vous êtes... Un professeur qui surveille le bureau des étudiants ?',
    ...
    "kevin Ça sera plus facile de te montrer, je crois... {{player.name}}, tu veux passer chez moi après l'école ?",
    'Je rougis visiblement.',
    "p Euh... Tu es sûr ? Je ne veux pas m'imposer...",
    "kevin Mais non ! Allez, c'est promis !",
    'hide character kevin with fadeOut',
    'Et sur ce, il se lève, son sourire en coin revenu, et va débarasser son plateau.',
    "Je reste un peu bouche-bée... Est-ce que j'ai mal compris ? On aurait presque dit...",
    "Bon, on verra bien, je suppose que je sais ce que je fais après l'école aujourd'hui !",
    'show scene black with fadeIn duration 1s',
    'wait 1000',
    'show scene class with fadeIn',
    "Le reste de l'après-midi est dédié aux langues et à l'histoire.",
    "Je fais de mon mieux pour suivre et prendre des notes, mais je suis distrait par l'invitation que j'ai reçu ce midi...",
    'play sound bell',
    "Finalement la cloche sonne la fin des cours de l'après-midi et je me retrouve entraîné par Kevin.",
    'show scene hall1 with fadeIn',
    'show character kevin default with fadeIn',
    'kevin Alors, cette première journée ?',
    'p Euh... Je vais devoir bosser pour vous rattraper, surtout les Maths !',
    'kevin Les Maths, hm ?',
    'stop music',
    'play music daylight',
    'show scene schoolEntrance with fadeIn',
    "kevin Viens, j'habite pas loin de l'école.",
    'show scene street with fadeIn',
    "Nous faisons notre chemin en discutant - je fais remarquer à Kevin que ce chemin n'est pas du tout un détour pour moi, c'est vers chez moi aussi.",
    'show character kevin surprised with fadeIn',
    "kevin Vraiment ? Super, on pourrait tous aller à l'école ensemble alors !",
    'Je hoche la tête, puis me reprend. "Tous" ?',
    'kevin Ah, on y est !',
    'show scene houseEntrance with fadeIn',
    'Nous entrons chez Kevin, il se tourne vers moi et sourit.',
    'show character kevin default at center with fadeIn',
    'kevin Bienvenue! Alors-',
    "unknwn C'est toi ma couille?",
    'Hein? Est-ce que ses parents sont là ?',
    "p Euh, qu'est-ce que...",
    'show character pm default at left with fadeIn',
    "Je suis interrompu par l'étudiant que j'ai vu ce matin qui s'avance vers nous.",
    'show character pm surprised at left with fadeIn',
    "unknwn Ben tu ramènes un invité et tu le dis pas? T'es chiant toi, quand même.",
    'p Euh, attends, vous vivez ensemble tous les deux ?',
    "kevin Ben justement, j'essayais de t'expliquer-",
    "La porte s'ouvre brusquement derrière moi, me faisant sursauter, je me retourne pour voir...",
    'show character max default at right with fadeIn',
    'max Yo.',
    'play sound doorClose',
    'show character max surprised at right',
    'max Ah. Bienvenue chez nous.',
    'stop music with fade 2',
    'show character kevin shy at center with fadeIn',
    "kevin ...t'expliquer, donc, qu'on est collocs, tous les trois !",
    'play music lullaby',
    "Je suis un peu surpris face à eux - puis les paroles de Kevin prennent tout leur sens. Tout de même, c'est loin d'être banal.",
    "Moi qui pensais trouver des aventures à Blackfoot Academy, j'ai soudain le sentiment que ces trois-là seront certainement toute une aventure...",
    "Si seulement j'avais su à ce moment là, les yeux posés sur ces trois garçons, que mon premier amour se tenait juste sous mes yeux !",
    'stop music',
